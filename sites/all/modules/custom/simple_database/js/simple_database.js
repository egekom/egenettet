/**
 * @file
 * Sets the summary for Simple Database on vertical tabs.
 */

(function ($) {
  Drupal.behaviors.simpleDatabaseSettingsSummary = {
    attach: function (context) {
      // Provide the vertical tab summaries.
      $('fieldset#edit-simple-database', context).drupalSetSummary(function(context) {
        var vals = [];
