 ...
 */
?>
<div class="panel-4col-25-left-stack-profile-extended panel-display">
  ...
  <div class="panel-col-first">
    ...
    <div class="row-two row">
      <!-- Left one -->
      <div class="panel-col-one panel-panel inner-column">
        <div class="inside"><?php print $content['left_one_2']; ?></div>
      </div>
      <!-- Left two wide -->
      <div class="panel-col-two panel-panel inner-column double">
        <div class="inside"><?php print $content['left_two_2']; ?></div>
      </div>
    </div>
