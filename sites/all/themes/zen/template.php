...
function zen_preprocess_node(&$variables, $hook) {
  ...
  $variables['pubdate'] = '<time pubdate datetime="' . format_date($variables['node']->created, 'custom', 'c') . '"><span class="danish-date-format">' . $variables['date'] . '</span></time>';
...
function zen_preprocess_comment(&$variables, $hook) {
  ...
  // Add pubdate to submitted variable.
  $variables['pubdate'] = '<time pubdate datetime="' . format_date($variables['comment']->created, 'custom', 'c') . '"><span class="danish-date-format">' . $variables['created'] . '</span></time>';
