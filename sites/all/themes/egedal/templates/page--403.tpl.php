...
<div id="page" class="error-403">

<div class="error-403-wrapper">
  <div class="error-403-content"><img src="/sites/all/themes/egedal/images/403.svg" alt="403" class="403-img"></div>
</div>

<div class="error-403-info">
  <?php print t('Skal der være tekst på denne side, skal de være her og også i 2 linier med et '); ?>
  <a href="<?php print $front_page; ?>" title="403" rel="403" class="error-link"><?php print t('tekstlink'); ?></a>
